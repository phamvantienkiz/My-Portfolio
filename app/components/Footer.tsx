...
export default function Footer(): React.JSX.Element {
  return (
    <footer id="contact" className="py-10 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            Interested in building next-gen AI solutions, automating workflows, 
            or collaborating on AIoT and Computer Vision projects? Let&apos;s connect.
          </p>
          <a
