        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-purple-400">Who I Am</h3>
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              <h3 className="text-xl font-semibold text-purple-400">Awards &amp; Recognition</h3>
            ...
            <div className="space-y-4 pt-4 border-t border-white/10">
              ...
              <div className="flex gap-3 flex-wrap text-sm text-white/90">
                <span className="bg-purple-950/40 border border-purple-500/20 px-3 py-1 rounded-full">
                  🇻🇳 Vietnamese (Native)
                </span>
                <span className="bg-purple-950/40 border border-purple-500/20 px-3 py-1 rounded-full">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            {skillCategories.map((category, idx) => (
              <div 
                key={idx}
                className="bg-slate-950/50 backdrop-blur-sm p-6 rounded-2xl border border-white/5 hover:border-purple-500/30 transition-all duration-300 shadow-lg"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIdx) => (
                    <span 
                      key={skillIdx}
                      className="bg-white/5 hover:bg-purple-500/20 text-white/90 hover:text-white px-3 py-1 rounded-lg text-sm border border-white/10 hover:border-purple-500/30 transition-all duration-200"
                    >
                      {skill}
                    </span>
                  ))}
